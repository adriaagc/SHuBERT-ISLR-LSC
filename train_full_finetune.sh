#!/bin/bash
#SBATCH --job-name=1B_full_finetune
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:h100:1
#SBATCH --time=3:00:00
#SBATCH --output=/home/agarciac/logs/1B/slurm_%x_%j.out     #/path_to_output_logs_dir/slurm_%x.out
#SBATCH --error=/home/agarciac/logs/1B/slurm_%x_%j.err      #/path_to_output_logs_dir/slurm_%x.err
...
config=islr_full_finetune                               # name of the .yaml file
code_dir=$fairseq_root/examples/shubert                 # dir where shubert.py and shubert_isrl.py are  


# create log dir
log_dir=/home/agarciac/logs/1B #/path_to_output_logs_dir/log_dir_name
mkdir -p $log_dir
...
export WANDB_NAME="islr_shubert_full_finetune" # this is the run name
export WANDB_RUN_GROUP="1B_full_finetune"  # to organise the wandb workspace in groups
